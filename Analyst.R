...
#plot Seurat object
pan_plot<-DimPlot(pan_umap, reduction = 'umap')

#custom labels
UMAP_DE<-pan_plot + labs(title = "Pancreas Gene Clustering", repel = TRUE, label_size = 2)+DarkTheme()
...
#Create Heatmap & Save, using TOP 5 
...
#create Featureplots based on top DE genes, as expressed on heatmap and paper-Save
